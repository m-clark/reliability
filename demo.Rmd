...
<aside>Many will recognize this as the ICC or <span class="emph">intra-class correlation coefficient</span>.</aside>
...
For simplicity we will focus on the person variance only in our examples.
